...
public class Demo {
	...
	public static void main(String[] args) {
		...
		{
			Fleet f1 = new Fleet16091("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);

			f1 = new Fleet16091("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);
		}
